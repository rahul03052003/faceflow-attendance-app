...
export const USERS: User[] = [
  ...
  { id: '5', name: 'Ethan Davis', email: 'ethan@example.com', avatar: 'https://i.pravatar.cc/150?u=ethan@example.com', role: 'User' },
...
export const ATTENDANCE_RECORDS: AttendanceRecord[] = [
  ...
  { id: 'rec5', userId: '5', userName: 'Ethan Davis', userAvatar: 'https://i.pravatar.cc/150?u=ethan@example.com', date: getISODate(), status: 'Present', emotion: 'Sad' },
  ...
  { id: 'rec11', userId: '5', userName: 'Ethan Davis', userAvatar: 'https://i.pravatar.cc/150?u=ethan@example.com', date: getISODate(-1), status: 'Absent', emotion: 'N/A' },
